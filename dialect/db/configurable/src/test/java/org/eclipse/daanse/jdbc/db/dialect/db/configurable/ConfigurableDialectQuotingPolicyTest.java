...
class ConfigurableDialectQuotingPolicyTest {
    ...
    private ConfigurableDialect dialectNever() {
        ConfigurableDialect d = ConfigurableDialect.builder().quoteIdentifierString("\"").dialectName("test").build();
