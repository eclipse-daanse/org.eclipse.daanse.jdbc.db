...
/**
 * {@code createMetaInfo} vs lightweight dialect-init read latency on MariaDB
 * 10.11.
 */
class MariaDBInitMetaInfoLatencyTest {
    ...
    static void setUp() throws Exception {
        ...
        jdbcUrl = "jdbc:mariadb://" + MARIADB.getHost() + ":" + MARIADB.getMappedPort(3306) + "/" + DATABASE;
    }
    ...
    void measure() throws SQLException {
        DataSource ds = ds();
        System.out.println();
        System.out.println("=== MariaDB 10.11: createMetaInfo() vs lightweight dialect-init reads ===");
