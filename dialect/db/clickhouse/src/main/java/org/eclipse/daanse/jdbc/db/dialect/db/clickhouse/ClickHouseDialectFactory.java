...
public class ClickHouseDialectFactory extends AbstractDialectFactory<ClickHouseDialect> {

    @Override
    public Function<DialectInitData, ClickHouseDialect> getConstructorFunction() {
        return ClickHouseDialect::new;
    }
