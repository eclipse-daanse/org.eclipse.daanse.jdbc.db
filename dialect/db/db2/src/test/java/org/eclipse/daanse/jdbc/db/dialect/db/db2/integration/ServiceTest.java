 ...
 */
package org.eclipse.daanse.jdbc.db.dialect.db.db2.integration;
...
class ServiceTest {
    ...
    void serviceExists(@InjectService List<DialectFactory> dialects) throws Exception {
        ...
        assertThat(dialects).isNotNull().isNotEmpty().anyMatch(Db2DialectFactory.class::isInstance).anyMatch(Db2OldAs400DialectFactory.class::isInstance);
    }
}
